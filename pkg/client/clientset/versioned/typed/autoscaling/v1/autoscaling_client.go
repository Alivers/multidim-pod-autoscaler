...
import (
	...
	"multidim-pod-autoscaler/pkg/client/clientset/versioned/scheme"
...
func (c *AutoscalingV1Client) MultidimPodAutoscalers(namespace string) MultidimPodAutoscalerInterface {
